...
#warning it could be simpler
	...
	{
		string? goodsIds = HttpContext.Session.GetString(CommonNames.SeparatedGoodsIdsInCart);
		string? updatedgoodsIds = service.AddToOrRemoveFromCart(goodsId, isInCart, goodsIds);
