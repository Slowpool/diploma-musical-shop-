...
public abstract class CreateSaleBaseAction(SalesDbAccess dbAccess) : ErrorAdder
{
    public async Task<Guid?> Action(List<Goods> goodsItems, TypeOfNewSale typeOfSale, string? secretWord = null)
    {
        ...
        var sale = new Sale()
        {
            ...
            //SaleDate = typeOfSale == TypeOfNewSale.Sale ? DateTime.UtcNow : null,
            ReservationDate = typeOfSale == TypeOfNewSale.Reservation ? DateTime.UtcNow : null,
        ...
        switch (typeOfSale)
        {
            case TypeOfNewSale.Sale:
                await dbAccess.CreateSaleAndUpdateGoods(sale, goodsItems);
                break;
            case TypeOfNewSale.Reservation:
                ...
                await dbAccess.CreateReservationAndUpdateGoods(sale, goodsItems, secretWord);
                break;
        }
        return sale.SaleId;
    }
